  ...
  return (
    <Fragment>
      <Typography className={style.pos} color="textSecondary">
        El report es desde {data.date1} hasta {data.date2}
      </Typography>
          ...
          <Grid container item xs={12}>
            ...
            >
              <Typography variant="h6" component="h3">
                Nombre Empleados responsables
              </Typography>
              {data.employees.map((item) => {
                return(<Typography className={style.pos} color="textSecondary">
                  {item}
                </Typography>)
              })}

              <Typography variant="h6" component="h3">
                Reporte para el lote: 
              </Typography>
              <Typography className={style.pos} color="textSecondary">
                {data.lot}
              </Typography>
